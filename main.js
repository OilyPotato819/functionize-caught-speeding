...
function btnClicked() {
  ...
  document.getElementById("d1-ticket").innerHTML = giveTicket(d1Speed, d1Limit);
  document.getElementById("d2-ticket").innerHTML = giveTicket(d2Speed, d2Limit);
  document.getElementById("d3-ticket").innerHTML = giveTicket(d3Speed, d3Limit);
}

function giveTicket(speed, limit) {
  let ticket;
